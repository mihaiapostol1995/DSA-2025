...
//        new TestAspect().hello();
    ...
    @After("execution(public void org.example.aspects.TestAspect.hello())")
    public void afterHello(JoinPoint joinPoint) {
        System.err.println("after " + joinPoint);
    }

    @Around("execution(public void org.example.aspects.TestAspect.hello())")
    ...
    @Before("execution(public void org.example.aspects.TestAspect.hello())")
